        ...
        */
        for (int i = 0; i < regions.size(); i++) {
            ...
            if (regions[i].getExits().size() >= 2) {
                ...
                Door *doorToPush = new Door(FORRExit(CartesianPoint(-1,-1),CartesianPoint(-1,-1),CartesianPoint(-1,-1),-1, 0, 0), FORRExit(CartesianPoint(-1,-1),CartesianPoint(-1,-1),CartesianPoint(-1,-1),-1, 0, 0), 0);
                ...
                for (idx = exitAngles.begin(); idx != exitAngles.end()-1; idx++){
                    ...
                    if ((idx+1)->first - idx->first < epsilon) {
                        ...
                        doorToPush = new Door(FORRExit(CartesianPoint(-1,-1),CartesianPoint(-1,-1),CartesianPoint(-1,-1),-1, 0, 0), FORRExit(CartesianPoint(-1,-1),CartesianPoint(-1,-1),CartesianPoint(-1,-1),-1, 0, 0), 0); //prepare a new door
