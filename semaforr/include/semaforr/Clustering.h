...
public:
    SpectralCluster(int num_neighbors, int num_clusters, int min_cluster_size, double probability_cutoff){
        ...
        ofstream myfile;
        myfile.open("/home/rajkochhar/catkin_ws1/src/situation_learner/config/params.conf");
    ...
    vector< vector<float> > cluster(vector< vector<float> > data){
        ofstream mydatafile;
        mydatafile.open("/home/rajkochhar/catkin_ws1/src/situation_learner/config/data.txt");
        ...
        string clusterfilename = "/home/rajkochhar/catkin_ws1/src/situation_learner/config/clusters.txt";
        string fileLine;
    ...
    vector<int> clusterAssignments(){
        ...
        string clusterfilename = "/home/rajkochhar/catkin_ws1/src/situation_learner/config/clusterassignments.txt";
        string fileLine;
        std::ifstream file(clusterfilename.c_str());
        ROS_DEBUG_STREAM("Reading new_situation_file:" << clusterfilename);
        //cout << "Inside file in tasks " << endl;
