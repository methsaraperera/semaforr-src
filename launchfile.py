...
#     log_name = map_name + "_passagetest3_" + str(i) + ".txt"
...
# map_name = "map-a"
# target_file_name = "target40test.conf"
# log_name = map_name + "_T1_CS_SM_HP_1_" + str(i) + ".txt"
# advisors = "/config/advisors2.conf"
# params = "/config/params5.conf"
# situations = "/config/situations5.conf"
# spatials = "/config/spatial_model.conf"
...
# i = 7
# map_name = "map-c"
# target_file_name = "target40test-3.conf"
# log_name = map_name + "_T1_CS_SM_HP_3_" + str(i) + ".txt"
# advisors = "/config/advisors2.conf"
# params = "/config/params5.conf"
# situations = "/config/situations5.conf"
# spatials = "/config/spatial_model.conf"
...
for i in range(0,num_runs):
    # map_name = "gradcenter-5"
    # target_file_name = "target1.conf"
    # log_name = map_name + "_T1_CS_SM_HP_EX_OH_1_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    ...
    # log_name = map_name + "_T1_CS_SM_HP_EX_OH_2_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # log_name = map_name + "_T1_CS_SM_HP_EX_OH_3_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # log_name = map_name + "_T1_CS_SM_HP_EX_OH_4_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # log_name = map_name + "_T1_CS_SM_HP_EX_OH_5_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    map_name = "moma-5"
    target_file_name = "target40test.conf"
    log_name = map_name + "_T1_CS_SM_1_" + str(i) + ".txt"
    advisors = "/config/advisors2.conf"
    params = "/config/params4.conf"
    situations = "/config/situations5.conf"
    spatials = "/config/spatial_model.conf"
    ...
    experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    map_name = "moma-5"
    target_file_name = "target40test-2.conf"
    log_name = map_name + "_T1_CS_SM_2_" + str(i) + ".txt"
    advisors = "/config/advisors2.conf"
    params = "/config/params4.conf"
    situations = "/config/situations5.conf"
    spatials = "/config/spatial_model.conf"
    ...
    map_name = "moma-5"
    target_file_name = "target40test-3.conf"
    log_name = map_name + "_T1_CS_SM_3_" + str(i) + ".txt"
    advisors = "/config/advisors2.conf"
    params = "/config/params4.conf"
    situations = "/config/situations5.conf"
    spatials = "/config/spatial_model.conf"
    ...
    experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    map_name = "moma-5"
    target_file_name = "target40test-4.conf"
    log_name = map_name + "_T1_CS_SM_4_" + str(i) + ".txt"
    advisors = "/config/advisors2.conf"
    params = "/config/params4.conf"
    situations = "/config/situations5.conf"
    spatials = "/config/spatial_model.conf"
    ...
    experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    map_name = "moma-5"
    target_file_name = "target40test-5.conf"
    log_name = map_name + "_T1_CS_SM_5_" + str(i) + ".txt"
    advisors = "/config/advisors2.conf"
    params = "/config/params4.conf"
    situations = "/config/situations5.conf"
    spatials = "/config/spatial_model.conf"
...
#     experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    # map_name = "map-c"
    # target_file_name = "target40test.conf"
    # log_name = map_name + "_T1_CS_SM_HP_EX_1_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params5.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # map_name = "moma-5"
    # target_file_name = "target40test.conf"
    # log_name = map_name + "_T1_1_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
...
#     map_name = "map-a"
#     target_file_name = "target40test-2.conf"
#     log_name = map_name + "_T1_CS_SM_HP_2_" + str(i) + ".txt"
#     advisors = "/config/advisors2.conf"
#     params = "/config/params5.conf"
#     situations = "/config/situations5.conf"
#     spatials = "/config/spatial_model.conf"
...
#     experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    # map_name = "map-c"
    # target_file_name = "target40test-2.conf"
    # log_name = map_name + "_T1_CS_SM_HP_EX_2_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params5.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # map_name = "moma-5"
    # target_file_name = "target40test-2.conf"
    # log_name = map_name + "_T1_2_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
...
#     experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    # map_name = "map-c"
    # target_file_name = "target40test-3.conf"
    # log_name = map_name + "_T1_CS_SM_HP_EX_3_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params5.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # map_name = "moma-5"
    # target_file_name = "target40test-3.conf"
    # log_name = map_name + "_T1_3_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
...
#     map_name = "map-a"
#     target_file_name = "target40test-4.conf"
#     log_name = map_name + "_T1_CS_SM_HP_4_" + str(i) + ".txt"
#     advisors = "/config/advisors2.conf"
#     params = "/config/params5.conf"
#     situations = "/config/situations5.conf"
#     spatials = "/config/spatial_model.conf"
...
#     experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    # map_name = "map-c"
    # target_file_name = "target40test-4.conf"
    # log_name = map_name + "_T1_CS_SM_HP_EX_4_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params5.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # map_name = "moma-5"
    # target_file_name = "target40test-4.conf"
    # log_name = map_name + "_T1_4_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
...
#     map_name = "map-a"
#     target_file_name = "target40test-5.conf"
#     log_name = map_name + "_T1_CS_SM_HP_5_" + str(i) + ".txt"
#     advisors = "/config/advisors2.conf"
#     params = "/config/params5.conf"
#     situations = "/config/situations5.conf"
#     spatials = "/config/spatial_model.conf"
...
#     experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
    # map_name = "map-c"
    # target_file_name = "target40test-5.conf"
    # log_name = map_name + "_T1_CS_SM_HP_EX_5_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params5.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
    ...
    # map_name = "moma-5"
    # target_file_name = "target40test-5.conf"
    # log_name = map_name + "_T1_5_" + str(i) + ".txt"
    # advisors = "/config/advisors2.conf"
    # params = "/config/params4.conf"
    # situations = "/config/situations5.conf"
    # spatials = "/config/spatial_model.conf"
...
#     # experiment(map_name, log_name, density, flow, risk, cusum, discount, explore, advisors, params, situations, spatials)
#     # target_file_name = "target5.conf"
#     # log_name = map_name + "_highretry5_" + str(i) + ".txt"
