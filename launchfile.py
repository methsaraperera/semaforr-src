...
for i in range(0,num_runs):
    ...
    log_name = map_name + "_" + "full_spatial_model" + "_" + str(i) + ".txt"
...
for i in range(0,num_runs):
    target_file_name = "target1.conf"
    log_name = map_name + "_" + "trails" + "_" + str(i) + ".txt"
...
for i in range(0,num_runs):
    target_file_name = "target1.conf"
    log_name = map_name + "_" + "conveyors" + "_" + str(i) + ".txt"
...
for i in range(0,num_runs):
    target_file_name = "target1.conf"
    log_name = map_name + "_" + "regions" + "_" + str(i) + ".txt"
...
for i in range(0,num_runs):
    target_file_name = "target1.conf"
    log_name = map_name + "_" + "hallways" + "_" + str(i) + ".txt"
...
for i in range(0,num_runs):
    target_file_name = "target1.conf"
    log_name = map_name + "_" + "no_model" + "_" + str(i) + ".txt"
